...
var file_platform_data_proto_rawDesc = []byte{
	...
	0x32, 0xd2, 0x0b, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x65, 0x76, 0x69, 0x63, 0x65, 0x2d, 0x64, 0x61, 0x74, 0x61, 0x12, 0x70, 0x0a, 0x0d, 0x47, 0x65,
...
var file_platform_data_proto_goTypes = []any{
	...
	nil,                                    // 37: platform.GetAggregatedDataRequest.FieldsEntry
...
var file_platform_data_proto_depIdxs = []int32{
	...
	44, // 13: platform.InsertFromDataloggerRequest.protocol:type_name -> platform.TransportProtocol
	42, // 14: platform.InsertFromDataloggerRequest.data:type_name -> google.protobuf.Value
	42, // 15: platform.InsertFromDataloggerRequest.original_data:type_name -> google.protobuf.Value
	41, // 16: platform.InsertFromDataloggerRequest.received_at:type_name -> google.protobuf.Timestamp
	42, // 17: platform.InsertFromDataloggerRequest.metadata:type_name -> google.protobuf.Value
	0,  // 18: platform.InsertDataRequest.data:type_name -> platform.DeviceData
	41, // 19: platform.GetDeviceDataRequest.start_time:type_name -> google.protobuf.Timestamp
	41, // 20: platform.GetDeviceDataRequest.end_time:type_name -> google.protobuf.Timestamp
	0,  // 21: platform.GetDeviceDataResponse.data:type_name -> platform.DeviceData
	41, // 22: platform.GetAggregatedDataRequest.start_time:type_name -> google.protobuf.Timestamp
	41, // 23: platform.GetAggregatedDataRequest.end_time:type_name -> google.protobuf.Timestamp
	45, // 24: platform.GetAggregatedDataRequest.aggregation:type_name -> platform.AggregationType
	46, // 25: platform.GetAggregatedDataRequest.interval:type_name -> platform.TimeInterval
	37, // 26: platform.GetAggregatedDataRequest.fields:type_name -> platform.GetAggregatedDataRequest.FieldsEntry
	41, // 27: platform.AggregatedDataPoint.timestamp:type_name -> google.protobuf.Timestamp
	38, // 28: platform.AggregatedDataPoint.values:type_name -> platform.AggregatedDataPoint.ValuesEntry
	18, // 29: platform.GetAggregatedDataResponse.data:type_name -> platform.AggregatedDataPoint
	0,  // 30: platform.GetLatestDataResponse.data:type_name -> platform.DeviceData
	41, // 31: platform.GetMultiDeviceDataRequest.start_time:type_name -> google.protobuf.Timestamp
	41, // 32: platform.GetMultiDeviceDataRequest.end_time:type_name -> google.protobuf.Timestamp
	39, // 33: platform.GetMultiDeviceDataResponse.device_data:type_name -> platform.GetMultiDeviceDataResponse.DeviceDataEntry
	41, // 34: platform.DeleteDeviceDataRequest.start_time:type_name -> google.protobuf.Timestamp
	41, // 35: platform.DeleteDeviceDataRequest.end_time:type_name -> google.protobuf.Timestamp
	41, // 36: platform.GetDataStatsRequest.start_time:type_name -> google.protobuf.Timestamp
	41, // 37: platform.GetDataStatsRequest.end_time:type_name -> google.protobuf.Timestamp
	41, // 38: platform.DataStats.first_timestamp:type_name -> google.protobuf.Timestamp
	41, // 39: platform.DataStats.last_timestamp:type_name -> google.protobuf.Timestamp
	27, // 40: platform.DataStats.size_stats:type_name -> platform.DataSizeStats
	26, // 41: platform.GetDataStatsResponse.stats:type_name -> platform.DataStats
	11, // 42: platform.UpdateDeviceLocationRequest.location:type_name -> platform.DeviceLocation
	41, // 43: platform.UpdateDeviceLocationRequest.timestamp:type_name -> google.protobuf.Timestamp
	11, // 44: platform.GetDeviceLocationResponse.location:type_name -> platform.DeviceLocation
	41, // 45: platform.GetDeviceLocationResponse.updated_at:type_name -> google.protobuf.Timestamp
	40, // 46: platform.GetMultiDeviceLocationResponse.locations:type_name -> platform.GetMultiDeviceLocationResponse.LocationsEntry
	47, // 47: platform.GetAggregatedDataRequest.FieldsEntry.value:type_name -> platform.FieldType
	16, // 48: platform.GetMultiDeviceDataResponse.DeviceDataEntry.value:type_name -> platform.GetDeviceDataResponse
	31, // 49: platform.GetMultiDeviceLocationResponse.LocationsEntry.value:type_name -> platform.GetDeviceLocationResponse
	14, // 50: platform.DataService.Insert:input_type -> platform.InsertDataRequest
	12, // 51: platform.DataService.InsertFromDatalogger:input_type -> platform.InsertFromDataloggerRequest
	15, // 52: platform.DataService.GetDeviceData:input_type -> platform.GetDeviceDataRequest
	17, // 53: platform.DataService.GetAggregatedData:input_type -> platform.GetAggregatedDataRequest
	20, // 54: platform.DataService.GetLatestData:input_type -> platform.GetLatestDataRequest
	22, // 55: platform.DataService.GetMultiDeviceData:input_type -> platform.GetMultiDeviceDataRequest
	24, // 56: platform.DataService.DeleteDeviceData:input_type -> platform.DeleteDeviceDataRequest
	25, // 57: platform.DataService.GetDataStats:input_type -> platform.GetDataStatsRequest
	29, // 58: platform.DataService.UpdateDeviceLocation:input_type -> platform.UpdateDeviceLocationRequest
	30, // 59: platform.DataService.GetDeviceLocation:input_type -> platform.GetDeviceLocationRequest
	32, // 60: platform.DataService.GetMultiDeviceLocation:input_type -> platform.GetMultiDeviceLocationRequest
	34, // 61: platform.DataService.DeleteDeviceLocation:input_type -> platform.DeleteDeviceLocationRequest
	48, // 62: platform.DataService.Insert:output_type -> google.protobuf.Empty
	13, // 63: platform.DataService.InsertFromDatalogger:output_type -> platform.InsertFromDataloggerResponse
	16, // 64: platform.DataService.GetDeviceData:output_type -> platform.GetDeviceDataResponse
	19, // 65: platform.DataService.GetAggregatedData:output_type -> platform.GetAggregatedDataResponse
	21, // 66: platform.DataService.GetLatestData:output_type -> platform.GetLatestDataResponse
	23, // 67: platform.DataService.GetMultiDeviceData:output_type -> platform.GetMultiDeviceDataResponse
	48, // 68: platform.DataService.DeleteDeviceData:output_type -> google.protobuf.Empty
	28, // 69: platform.DataService.GetDataStats:output_type -> platform.GetDataStatsResponse
	48, // 70: platform.DataService.UpdateDeviceLocation:output_type -> google.protobuf.Empty
	31, // 71: platform.DataService.GetDeviceLocation:output_type -> platform.GetDeviceLocationResponse
	33, // 72: platform.DataService.GetMultiDeviceLocation:output_type -> platform.GetMultiDeviceLocationResponse
	48, // 73: platform.DataService.DeleteDeviceLocation:output_type -> google.protobuf.Empty
