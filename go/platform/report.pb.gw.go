...
var (
	filter_ReportService_DownloadReport_0 = &utilities.DoubleArray{Encoding: map[string]int{"report_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_ReportService_DownloadReport_0(ctx context.Context, marshaler runtime.Marshaler, client ReportServiceClient, req *http.Request, pathParams map[string]string) (ReportService_DownloadReportClient, runtime.ServerMetadata, error) {
...
func RegisterReportServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReportServiceClient) error {
	...
	mux.Handle("GET", pattern_ReportService_DownloadReport_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_ReportService_DownloadReport_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ReportService_ListReports_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"api", "reports"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_ReportService_DownloadReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"api", "reports", "report_id", "download"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_ReportService_ListReports_0 = runtime.ForwardResponseMessage

	forward_ReportService_DownloadReport_0 = runtime.ForwardResponseStream
)
