...
type LoRaWANDevice struct {
	...
	// Device join mode.
	JoinMode JoinMode `protobuf:"varint,5,opt,name=join_mode,json=joinMode,proto3,enum=api.JoinMode" json:"join_mode,omitempty"`
	// Device class.
	DeviceClass DeviceClass `protobuf:"varint,6,opt,name=device_class,json=deviceClass,proto3,enum=api.DeviceClass" json:"device_class,omitempty"`
	// Regional parameters region.
	Region Region `protobuf:"varint,7,opt,name=region,proto3,enum=api.Region" json:"region,omitempty"`
	// MAC version.
	MacVersion MacVersion `protobuf:"varint,8,opt,name=mac_version,json=macVersion,proto3,enum=api.MacVersion" json:"mac_version,omitempty"`
	// Regional parameters revision.
	RegParamsRevision RegParamsRevision `protobuf:"varint,9,opt,name=reg_params_revision,json=regParamsRevision,proto3,enum=api.RegParamsRevision" json:"reg_params_revision,omitempty"`
	// ADR (adaptive data rate) enabled.
	AdrEnabled bool `protobuf:"varint,10,opt,name=adr_enabled,json=adrEnabled,proto3" json:"adr_enabled,omitempty"`
	// Expected uplink interval in seconds.
	ExpectedUplinkIntervalSec uint32 `protobuf:"varint,11,opt,name=expected_uplink_interval_sec,json=expectedUplinkIntervalSec,proto3" json:"expected_uplink_interval_sec,omitempty"`
	// Device tags.
	...
	SkipFcntCheck bool `protobuf:"varint,14,opt,name=skip_fcnt_check,json=skipFcntCheck,proto3" json:"skip_fcnt_check,omitempty"`
	// Device is disabled.
	...
	JoinEui string `protobuf:"bytes,16,opt,name=join_eui,json=joinEui,proto3" json:"join_eui,omitempty"`
	// Device Keys for OTAA
	Keys *DeviceKeys `protobuf:"bytes,17,opt,name=keys,proto3" json:"keys,omitempty"`
	// Device activation object.
	DeviceActivation *DeviceActivation `protobuf:"bytes,18,opt,name=device_activation,json=deviceActivation,proto3" json:"device_activation,omitempty"`
	// ADR algorithm ID.
	AdrAlgorithmId string `protobuf:"bytes,19,opt,name=adr_algorithm_id,json=adrAlgorithmId,proto3" json:"adr_algorithm_id,omitempty"`
	// Payload codec runtime.
	PayloadCodecRuntime CodecRuntime `protobuf:"varint,20,opt,name=payload_codec_runtime,json=payloadCodecRuntime,proto3,enum=api.CodecRuntime" json:"payload_codec_runtime,omitempty"`
	// Payload codec script.
	PayloadCodecScript string `protobuf:"bytes,21,opt,name=payload_codec_script,json=payloadCodecScript,proto3" json:"payload_codec_script,omitempty"`
	// Class-B timeout (seconds).
	ClassBTimeout uint32 `protobuf:"varint,22,opt,name=class_b_timeout,json=classBTimeout,proto3" json:"class_b_timeout,omitempty"`
	// Class-B ping-slots per beacon period.
	ClassBPingSlotNbK uint32 `protobuf:"varint,23,opt,name=class_b_ping_slot_nb_k,json=classBPingSlotNbK,proto3" json:"class_b_ping_slot_nb_k,omitempty"`
	// Class-B ping-slot DR.
	ClassBPingSlotDr uint32 `protobuf:"varint,24,opt,name=class_b_ping_slot_dr,json=classBPingSlotDr,proto3" json:"class_b_ping_slot_dr,omitempty"`
	// Class-B ping-slot freq (Hz).
	ClassBPingSlotFreq uint32 `protobuf:"varint,25,opt,name=class_b_ping_slot_freq,json=classBPingSlotFreq,proto3" json:"class_b_ping_slot_freq,omitempty"`
	// Class-C timeout (seconds).
	ClassCTimeout uint32 `protobuf:"varint,26,opt,name=class_c_timeout,json=classCTimeout,proto3" json:"class_c_timeout,omitempty"`
	// RX1 delay (for ABP).
	AbpRx1Delay uint32 `protobuf:"varint,27,opt,name=abp_rx1_delay,json=abpRx1Delay,proto3" json:"abp_rx1_delay,omitempty"`
	// RX1 DR offset (for ABP).
	AbpRx1DrOffset uint32 `protobuf:"varint,28,opt,name=abp_rx1_dr_offset,json=abpRx1DrOffset,proto3" json:"abp_rx1_dr_offset,omitempty"`
	// RX2 DR (for ABP).
	AbpRx2Dr uint32 `protobuf:"varint,29,opt,name=abp_rx2_dr,json=abpRx2Dr,proto3" json:"abp_rx2_dr,omitempty"`
	// RX2 frequency (for ABP, Hz).
	AbpRx2Freq uint32 `protobuf:"varint,30,opt,name=abp_rx2_freq,json=abpRx2Freq,proto3" json:"abp_rx2_freq,omitempty"`
	// Flush queue on device activation.
	FlushQueueOnActivate bool `protobuf:"varint,31,opt,name=flush_queue_on_activate,json=flushQueueOnActivate,proto3" json:"flush_queue_on_activate,omitempty"`
...
type LoRaWANGateway struct {
	...
	// statistics.
	StatsInterval uint32 `protobuf:"varint,6,opt,name=stats_interval,json=statsInterval,proto3" json:"stats_interval,omitempty"`
	// Gateway region.
	Region Region `protobuf:"varint,7,opt,name=region,proto3,enum=api.Region" json:"region,omitempty"`
	// Gateway model.
	...
	NetworkConfig map[string]string `protobuf:"bytes,11,rep,name=network_config,json=networkConfig,proto3" json:"network_config,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_external_service_lorawan_types_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x1a, 0x23, 0x65, 0x78, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x73, 0x68,
	0x61, 0x72, 0x65, 0x64, 0x5f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x22, 0xb2, 0x0c, 0x0a, 0x0d, 0x4c, 0x6f, 0x52, 0x61, 0x57, 0x41, 0x4e, 0x44, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x64, 0x65, 0x76, 0x5f, 0x65, 0x75, 0x69, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x65, 0x76, 0x45, 0x75, 0x69, 0x12, 0x20, 0x0a, 0x0b, 0x64,
	...
	,
	...
	,
	...
	0x68, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x13, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x61, 0x64, 0x72,
	...
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x61, 0x70, 0x69,
	...
	0x64, 0x65, 0x63, 0x5f, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09,
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x63,
	...
	0x74, 0x5f, 0x6e, 0x62, 0x5f, 0x6b, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x63, 0x6c,
	...
	0x73, 0x6c, 0x6f, 0x74, 0x5f, 0x64, 0x72, 0x18, 0x18, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x63,
	...
	0x73, 0x6c, 0x6f, 0x74, 0x5f, 0x66, 0x72, 0x65, 0x71, 0x18, 0x19, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x63, 0x6c,
	0x61, 0x73, 0x73, 0x43, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x22, 0x0a, 0x0d, 0x61,
	0x62, 0x70, 0x5f, 0x72, 0x78, 0x31, 0x5f, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x18, 0x1b, 0x20, 0x01,
	...
	0x66, 0x73, 0x65, 0x74, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x61, 0x62, 0x70, 0x52,
	0x78, 0x31, 0x44, 0x72, 0x4f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x1c, 0x0a, 0x0a, 0x61, 0x62,
	0x70, 0x5f, 0x72, 0x78, 0x32, 0x5f, 0x64, 0x72, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08,
	0x61, 0x62, 0x70, 0x52, 0x78, 0x32, 0x44, 0x72, 0x12, 0x20, 0x0a, 0x0c, 0x61, 0x62, 0x70, 0x5f,
	0x72, 0x78, 0x32, 0x5f, 0x66, 0x72, 0x65, 0x71, 0x18, 0x1e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a,
	...
	0x69, 0x76, 0x61, 0x74, 0x65, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x08, 0x52, 0x14, 0x66, 0x6c, 0x75,
	0x73, 0x68, 0x51, 0x75, 0x65, 0x75, 0x65, 0x4f, 0x6e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74,
	0x65, 0x12, 0x3b, 0x0a, 0x1a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x5f, 0x72, 0x65, 0x71, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x18,
	0x20, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x17, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x1a, 0x37,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x57, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4b,
	...
	0x73, 0x5f, 0x69, 0x6e, 0x74, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	,
	...
	0x6f, 0x6e, 0x12, 0x29, 0x0a, 0x08, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03,
	...
	0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x4c, 0x6f, 0x52, 0x61, 0x57, 0x41, 0x4e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	...
	,
	...
	0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x45, 0x6e, 0x74,
	...
	0x65, 0x12, 0x2b, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x13, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x1a,
	0x0a, 0x08, 0x61, 0x63, 0x63, 0x75, 0x72, 0x61, 0x63, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02,
	0x52, 0x08, 0x61, 0x63, 0x63, 0x75, 0x72, 0x61, 0x63, 0x79, 0x2a, 0x1d, 0x0a, 0x08, 0x4a, 0x6f,
	0x69, 0x6e, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x54, 0x41, 0x41, 0x10, 0x00,
	0x12, 0x07, 0x0a, 0x03, 0x41, 0x42, 0x50, 0x10, 0x01, 0x2a, 0x34, 0x0a, 0x0b, 0x44, 0x65, 0x76,
	...
	,
	...
	0x41, 0x57, 0x41, 0x4e, 0x5f, 0x31, 0x5f, 0x31, 0x5f, 0x30, 0x10, 0x05, 0x2a, 0x76, 0x0a, 0x11,
	...
	0x33, 0x10, 0x05, 0x12, 0x0f, 0x0a, 0x0b, 0x52, 0x50, 0x30, 0x30, 0x32, 0x5f, 0x31, 0x5f, 0x30,
	0x5f, 0x34, 0x10, 0x06, 0x2a, 0x31, 0x0a, 0x0c, 0x43, 0x6f, 0x64, 0x65, 0x63, 0x52, 0x75, 0x6e,
	...
	0x06, 0x0a, 0x02, 0x4a, 0x53, 0x10, 0x02, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_external_service_lorawan_types_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
...
var file_external_service_lorawan_types_proto_goTypes = []any{
	(JoinMode)(0),            // 0: api.JoinMode
	(DeviceClass)(0),         // 1: api.DeviceClass
	(Region)(0),              // 2: api.Region
	(MacVersion)(0),          // 3: api.MacVersion
	(RegParamsRevision)(0),   // 4: api.RegParamsRevision
	(CodecRuntime)(0),        // 5: api.CodecRuntime
	(*LoRaWANDevice)(nil),    // 6: api.LoRaWANDevice
	(*DeviceKeys)(nil),       // 7: api.DeviceKeys
	(*DeviceActivation)(nil), // 8: api.DeviceActivation
	(*LoRaWANGateway)(nil),   // 9: api.LoRaWANGateway
	(*Location)(nil),         // 10: api.Location
	nil,                      // 11: api.LoRaWANDevice.TagsEntry
	nil,                      // 12: api.LoRaWANDevice.VariablesEntry
	nil,                      // 13: api.LoRaWANGateway.TagsEntry
	nil,                      // 14: api.LoRaWANGateway.MetadataEntry
	nil,                      // 15: api.LoRaWANGateway.NetworkConfigEntry
	(LocationSource)(0),      // 16: api.LocationSource
}
var file_external_service_lorawan_types_proto_depIdxs = []int32{
	0,  // 0: api.LoRaWANDevice.join_mode:type_name -> api.JoinMode
	1,  // 1: api.LoRaWANDevice.device_class:type_name -> api.DeviceClass
	2,  // 2: api.LoRaWANDevice.region:type_name -> api.Region
	3,  // 3: api.LoRaWANDevice.mac_version:type_name -> api.MacVersion
	4,  // 4: api.LoRaWANDevice.reg_params_revision:type_name -> api.RegParamsRevision
	11, // 5: api.LoRaWANDevice.tags:type_name -> api.LoRaWANDevice.TagsEntry
	12, // 6: api.LoRaWANDevice.variables:type_name -> api.LoRaWANDevice.VariablesEntry
	7,  // 7: api.LoRaWANDevice.keys:type_name -> api.DeviceKeys
	8,  // 8: api.LoRaWANDevice.device_activation:type_name -> api.DeviceActivation
	5,  // 9: api.LoRaWANDevice.payload_codec_runtime:type_name -> api.CodecRuntime
	10, // 10: api.LoRaWANGateway.location:type_name -> api.Location
	13, // 11: api.LoRaWANGateway.tags:type_name -> api.LoRaWANGateway.TagsEntry
	14, // 12: api.LoRaWANGateway.metadata:type_name -> api.LoRaWANGateway.MetadataEntry
	2,  // 13: api.LoRaWANGateway.region:type_name -> api.Region
	15, // 14: api.LoRaWANGateway.network_config:type_name -> api.LoRaWANGateway.NetworkConfigEntry
	16, // 15: api.Location.source:type_name -> api.LocationSource
