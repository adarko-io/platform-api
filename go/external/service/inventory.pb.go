...
const (
	...
	// LoRaWAN device.
	DeviceType_LORAWAN DeviceType = 1
	// Cellular MQTT device.
	DeviceType_CELLULAR_MQTT DeviceType = 2
	// Cellular TCP device.
	DeviceType_CELLULAR_TCP DeviceType = 3
	// Cellular UDP device.
	DeviceType_CELLULAR_UDP DeviceType = 4
	// Cellular HTTP device.
	DeviceType_CELLULAR_HTTP DeviceType = 5
	// Cellular CoAP device.
	DeviceType_CELLULAR_COAP DeviceType = 6
	// WiFi/Ethernet MQTT device.
	DeviceType_WIFI_MQTT DeviceType = 7
	// WiFi/Ethernet TCP device.
	DeviceType_WIFI_TCP DeviceType = 8
	// WiFi/Ethernet UDP device.
	DeviceType_WIFI_UDP DeviceType = 9
	// WiFi/Ethernet HTTP device.
	DeviceType_WIFI_HTTP DeviceType = 10
	// WiFi/Ethernet CoAP device.
	DeviceType_WIFI_COAP DeviceType = 11
	// WebSocket device.
	DeviceType_WEBSOCKET DeviceType = 12
	// Gateway device.
	DeviceType_GATEWAY DeviceType = 13
	// LoRaWAN Gateway device.
	DeviceType_LORAWAN_GATEWAY DeviceType = 14
)
...
func (DeviceType) Descriptor() protoreflect.EnumDescriptor {
	return file_external_service_inventory_proto_enumTypes[0].Descriptor()
}

func (DeviceType) Type() protoreflect.EnumType {
	return &file_external_service_inventory_proto_enumTypes[0]
}
...
const (
	...
	InventoryStatus_INVENTORY InventoryStatus = 0
	// Device onboarded to platform.
	InventoryStatus_ONBOARDED InventoryStatus = 1
	// Device provisioned and active.
	InventoryStatus_PROVISIONED InventoryStatus = 2
	// Device decommissioned.
	InventoryStatus_DECOMMISSIONED InventoryStatus = 3
	// Device reported as faulty.
	InventoryStatus_FAULTY InventoryStatus = 4
	// Device lost or stolen.
	InventoryStatus_LOST InventoryStatus = 5
)
...
func (InventoryStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_external_service_inventory_proto_enumTypes[1].Descriptor()
}

func (InventoryStatus) Type() protoreflect.EnumType {
	return &file_external_service_inventory_proto_enumTypes[1]
}
...
const (
	...
	DownlinkMode_IMMEDIATE DownlinkMode = 0
	// Queued downlink (for battery-powered devices, sent on next uplink).
	DownlinkMode_QUEUED DownlinkMode = 1
	// Scheduled downlink (sent at specific time).
	DownlinkMode_SCHEDULED DownlinkMode = 2
)
...
func (DownlinkMode) Descriptor() protoreflect.EnumDescriptor {
	return file_external_service_inventory_proto_enumTypes[2].Descriptor()
}

func (DownlinkMode) Type() protoreflect.EnumType {
	return &file_external_service_inventory_proto_enumTypes[2]
}
...
const (
	CellularNetworkType_CELLULAR_AUTO CellularNetworkType = 0
	CellularNetworkType_GSM_2G        CellularNetworkType = 1
	CellularNetworkType_UMTS_3G       CellularNetworkType = 2
	CellularNetworkType_LTE_4G        CellularNetworkType = 3
	CellularNetworkType_NR_5G         CellularNetworkType = 4
	CellularNetworkType_NB_IOT        CellularNetworkType = 5
	CellularNetworkType_LTE_M         CellularNetworkType = 6
)
...
func (CellularNetworkType) Descriptor() protoreflect.EnumDescriptor {
	return file_external_service_inventory_proto_enumTypes[3].Descriptor()
}

func (CellularNetworkType) Type() protoreflect.EnumType {
	return &file_external_service_inventory_proto_enumTypes[3]
}
...
type InventoryDevice struct {
	...
	DeviceType DeviceType `protobuf:"varint,4,opt,name=device_type,json=deviceType,proto3,enum=api.DeviceType" json:"device_type,omitempty"`
	...
	Procurement *ProcurementInfo `protobuf:"bytes,15,opt,name=procurement,proto3" json:"procurement,omitempty"`
}
...
func (x *InventoryDevice) GetStatus() InventoryStatus {
	...
	return InventoryStatus_INVENTORY
}
...
func (x *InventoryDevice) GetProcurement() *ProcurementInfo {
	if x != nil {
		return x.Procurement
	}
	return nil
}
...
type GatewayConfig struct {
	...
	SupportedDeviceTypes []DeviceType `protobuf:"varint,3,rep,packed,name=supported_device_types,json=supportedDeviceTypes,proto3,enum=api.DeviceType" json:"supported_device_types,omitempty"`
...
func (x *GatewayConfig) GetSupportedDeviceTypes() []DeviceType {
	if x != nil {
...
func (x *CellularMQTTConfig) GetNetworkType() CellularNetworkType {
	...
	return CellularNetworkType_CELLULAR_AUTO
}
...
type ProcurementInfo struct {
	...
	PurchaseOrder string `protobuf:"bytes,2,opt,name=purchase_order,json=purchaseOrder,proto3" json:"purchase_order,omitempty"`
	// Purchase date.
	...
	// Warranty expiry.
	WarrantyExpiry *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=warranty_expiry,json=warrantyExpiry,proto3" json:"warranty_expiry,omitempty"`
}

func (x *ProcurementInfo) Reset() {
	*x = ProcurementInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProcurementInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProcurementInfo) ProtoMessage() {}

func (x *ProcurementInfo) ProtoReflect() protoreflect.Message {
	mi := &file_external_service_inventory_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProcurementInfo.ProtoReflect.Descriptor instead.
func (*ProcurementInfo) Descriptor() ([]byte, []int) {
	return file_external_service_inventory_proto_rawDescGZIP(), []int{19}
}

func (x *ProcurementInfo) GetSupplier() string {
	if x != nil {
		return x.Supplier
	}
	return ""
...
func (x *ProcurementInfo) GetPurchaseOrder() string {
	if x != nil {
...
func (x *ProcurementInfo) GetPurchaseDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ProcurementInfo) GetUnitCost() float64 {
	if x != nil {
		return x.UnitCost
	}
	return 0
...
func (x *ProcurementInfo) GetCurrency() string {
	if x != nil {
		return x.Currency
	}
	return ""
...
func (x *ProcurementInfo) GetWarrantyExpiry() *timestamppb.Timestamp {
	if x != nil {
...
func (x *ListInventoryDevicesRequest) GetDeviceTypes() []DeviceType {
	if x != nil {
...
func (x *SearchInventoryDeviceResponse) Reset() {
	*x = SearchInventoryDeviceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_external_service_inventory_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchInventoryDeviceResponse) Descriptor() ([]byte, []int) {
	return file_external_service_inventory_proto_rawDescGZIP(), []int{34}
}
...
var file_external_service_inventory_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x1a, 0x24, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x6c, 0x6f, 0x72, 0x61, 0x77, 0x61, 0x6e, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xeb, 0x05, 0x0a, 0x0f, 0x49, 0x6e,
	0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x12, 0x10, 0x0a,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x30, 0x0a, 0x0b, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x5f,
	...
	0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x49, 0x6e,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x68, 0x61, 0x72, 0x64, 0x77,
	0x61, 0x72, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x29, 0x0a, 0x10, 0x66, 0x69,
	0x72, 0x6d, 0x77, 0x61, 0x72, 0x65, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x09,
	...
	,
	...
	0x0a, 0x08, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x62, 0x61, 0x74, 0x63, 0x68, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x0b, 0x70, 0x72, 0x6f,
	0x63, 0x75, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x63, 0x75, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x63, 0x75, 0x72, 0x65, 0x6d, 0x65, 0x6e,
	...
	,
	...
	,
	...
	0x28, 0x09, 0x52, 0x04, 0x69, 0x6d, 0x73, 0x69, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76,
	...
	,
	...
	0x04, 0x69, 0x6d, 0x73, 0x69, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f,
	...
	,
	...
	0x72, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x22, 0xe6, 0x02, 0x0a, 0x12, 0x43, 0x65, 0x6c, 0x6c, 0x75,
	0x6c, 0x61, 0x72, 0x43, 0x6f, 0x41, 0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x12, 0x0a,
	0x04, 0x69, 0x6d, 0x65, 0x69, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x6d, 0x65,
	0x69, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x6d, 0x73, 0x69, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x69, 0x6d, 0x73, 0x69, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f,
	0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	...
	0x0a, 0x0b, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x12,
	0x1f, 0x0a, 0x0b, 0x75, 0x70, 0x6c, 0x69, 0x6e, 0x6b, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x05,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x73, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x65,
	0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1f, 0x0a,
	...
	0x28, 0x0d, 0x52, 0x09, 0x6b, 0x65, 0x65, 0x70, 0x41, 0x6c, 0x69, 0x76, 0x65, 0x12, 0x2d, 0x0a,
	0x12, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65,
	0x6f, 0x75, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x63, 0x6f, 0x6e, 0x6e, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x20, 0x0a, 0x03,
	0x74, 0x6c, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x54, 0x4c, 0x53, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x03, 0x74, 0x6c, 0x73, 0x22, 0x7a,
	0x0a, 0x0d, 0x57, 0x69, 0x46, 0x69, 0x55, 0x44, 0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12,
	...
	0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x65, 0x6e, 0x64, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x50, 0x6f, 0x72, 0x74, 0x22, 0xbf, 0x02, 0x0a, 0x0e, 0x57,
	0x69, 0x46, 0x69, 0x48, 0x54, 0x54, 0x50, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x1f, 0x0a,
	...
	,
	...
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x63, 0x65, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	...
	0x52, 0x09, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4b, 0x65, 0x79, 0x22, 0xb4, 0x01, 0x0a, 0x08,
	0x48, 0x54, 0x54, 0x50, 0x41, 0x75, 0x74, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x75, 0x74,
	0x68, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	...
	,
	...
	0x09, 0x52, 0x06, 0x63, 0x61, 0x43, 0x65, 0x72, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x5f, 0x63, 0x65, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	...
	,
	...
	0x79, 0x22, 0x93, 0x02, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x63, 0x75, 0x72, 0x65, 0x6d, 0x65, 0x6e,
	0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1a, 0x0a, 0x08, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65,
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x69, 0x65,
	...
	,
	...
	,
	...
	0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x4c, 0x0a, 0x1c, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x06, 0x64, 0x65,
	0x76, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65,
	0x52, 0x06, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0x30, 0x0a, 0x1c, 0x44, 0x65, 0x6c, 0x65,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x75, 0x69, 0x22, 0xfc, 0x02, 0x0a, 0x1b, 0x4c,
	...
	0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x32, 0x0a, 0x0c, 0x64, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x0f,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x0b, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x73, 0x12, 0x30, 0x0a, 0x08,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0e, 0x32, 0x14,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x52, 0x08, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x12, 0x22,
	...
	0x09, 0x52, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68,
	0x12, 0x3e, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f,
	0x72, 0x79, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xcf, 0x02, 0x0a, 0x17, 0x49, 0x6e,
	0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x4c, 0x69, 0x73,
	0x74, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x75, 0x69, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x65, 0x75, 0x69, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x30, 0x0a, 0x0b, 0x64,
	...
	0x65, 0x52, 0x0a, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2c, 0x0a,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x22, 0x0a, 0x0c, 0x6d,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x39, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x77, 0x0a, 0x1c, 0x4c,
	0x69, 0x73, 0x74, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76, 0x69,
	...
	0x52, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x36, 0x0a, 0x07,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x07, 0x64, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x22, 0x71, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x44, 0x65,
	...
	0x65, 0x75, 0x69, 0x12, 0x2c, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74,
	0x6f, 0x72, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x6e, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x68, 0x0a, 0x11, 0x42, 0x75, 0x6c, 0x6b, 0x49,
	0x6d, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x07,
	...
	0x67, 0x22, 0xad, 0x01, 0x0a, 0x12, 0x42, 0x75, 0x6c, 0x6b, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74,
	...
	,
	...
	0x65, 0x73, 0x2a, 0x89, 0x02, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70,
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x6c,
	0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x49,
	0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x49,
	0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65,
	...
	0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x7b, 0x65, 0x75, 0x69, 0x7d, 0x12, 0x73, 0x0a, 0x06,
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x21, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74,
	0x79, 0x22, 0x2e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x28, 0x3a, 0x01, 0x2a, 0x1a, 0x23, 0x2f, 0x61,
	...
	,
	...
	0x18, 0x12, 0x16, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72,
	0x79, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x76, 0x0a, 0x0c, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1e, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x79, 0x22, 0x2e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x28, 0x3a, 0x01, 0x2a, 0x1a, 0x23, 0x2f, 0x61,
	0x70, 0x69, 0x2f, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x64, 0x65, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2f, 0x7b, 0x65, 0x75, 0x69, 0x7d, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x6c, 0x0a, 0x0a, 0x42, 0x75, 0x6c, 0x6b, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x12,
	0x16, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x42, 0x75, 0x6c, 0x6b, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x42, 0x75,
	0x6c, 0x6b, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x63, 0x65, 0x73, 0x2f, 0x62, 0x75, 0x6c, 0x6b, 0x2d, 0x69, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x12,
	0x79, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x21, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x44,
	0x65, 0x76, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f,
	...
	0x69, 0x2f, 0x69, 0x6e, 0x76, 0x65, 0x6e, 0x74, 0x6f, 0x72, 0x79, 0x2f, 0x64, 0x65, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69,
...
var file_external_service_inventory_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_external_service_inventory_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_external_service_inventory_proto_goTypes = []any{
	(DeviceType)(0),                       // 0: api.DeviceType
	(InventoryStatus)(0),                  // 1: api.InventoryStatus
	(DownlinkMode)(0),                     // 2: api.DownlinkMode
	(CellularNetworkType)(0),              // 3: api.CellularNetworkType
	(*InventoryDevice)(nil),               // 4: api.InventoryDevice
	(*DeviceConfiguration)(nil),           // 5: api.DeviceConfiguration
	(*GatewayConfig)(nil),                 // 6: api.GatewayConfig
	(*CellularMQTTConfig)(nil),            // 7: api.CellularMQTTConfig
	(*CellularTCPConfig)(nil),             // 8: api.CellularTCPConfig
	(*CellularUDPConfig)(nil),             // 9: api.CellularUDPConfig
	(*CellularHTTPConfig)(nil),            // 10: api.CellularHTTPConfig
	(*CellularCoAPConfig)(nil),            // 11: api.CellularCoAPConfig
	(*WiFiMQTTConfig)(nil),                // 12: api.WiFiMQTTConfig
	(*WiFiTCPConfig)(nil),                 // 13: api.WiFiTCPConfig
	(*WiFiUDPConfig)(nil),                 // 14: api.WiFiUDPConfig
	(*WiFiHTTPConfig)(nil),                // 15: api.WiFiHTTPConfig
	(*WiFiCoAPConfig)(nil),                // 16: api.WiFiCoAPConfig
	(*WebSocketConfig)(nil),               // 17: api.WebSocketConfig
	(*MQTTAuth)(nil),                      // 18: api.MQTTAuth
	(*HTTPAuth)(nil),                      // 19: api.HTTPAuth
	(*WebSocketAuth)(nil),                 // 20: api.WebSocketAuth
	(*TLSConfig)(nil),                     // 21: api.TLSConfig
	(*DTLSConfig)(nil),                    // 22: api.DTLSConfig
	(*ProcurementInfo)(nil),               // 23: api.ProcurementInfo
	(*CreateInventoryDeviceRequest)(nil),  // 24: api.CreateInventoryDeviceRequest
	(*CreateInventoryDeviceResponse)(nil), // 25: api.CreateInventoryDeviceResponse
	(*GetInventoryDeviceRequest)(nil),     // 26: api.GetInventoryDeviceRequest
	(*GetInventoryDeviceResponse)(nil),    // 27: api.GetInventoryDeviceResponse
	(*UpdateInventoryDeviceRequest)(nil),  // 28: api.UpdateInventoryDeviceRequest
	(*DeleteInventoryDeviceRequest)(nil),  // 29: api.DeleteInventoryDeviceRequest
	(*ListInventoryDevicesRequest)(nil),   // 30: api.ListInventoryDevicesRequest
	(*InventoryDeviceListItem)(nil),       // 31: api.InventoryDeviceListItem
	(*ListInventoryDevicesResponse)(nil),  // 32: api.ListInventoryDevicesResponse
	(*UpdateDeviceStatusRequest)(nil),     // 33: api.UpdateDeviceStatusRequest
	(*BulkImportRequest)(nil),             // 34: api.BulkImportRequest
	(*BulkImportResponse)(nil),            // 35: api.BulkImportResponse
	(*ImportError)(nil),                   // 36: api.ImportError
	(*SearchInventoryDeviceRequest)(nil),  // 37: api.SearchInventoryDeviceRequest
	(*SearchInventoryDeviceResponse)(nil), // 38: api.SearchInventoryDeviceResponse
	nil,                                   // 39: api.InventoryDevice.TagsEntry
	nil,                                   // 40: api.InventoryDevice.MetadataEntry
	nil,                                   // 41: api.GatewayConfig.NetworkConfigEntry
	nil,                                   // 42: api.WebSocketAuth.CredentialsEntry
	nil,                                   // 43: api.ListInventoryDevicesRequest.TagsEntry
	nil,                                   // 44: api.SearchInventoryDeviceRequest.CriteriaEntry
	(*LoRaWANDevice)(nil),                 // 45: api.LoRaWANDevice
	(*LoRaWANGateway)(nil),                // 46: api.LoRaWANGateway
	(*timestamppb.Timestamp)(nil),         // 47: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),                 // 48: google.protobuf.Empty
}
var file_external_service_inventory_proto_depIdxs = []int32{
	0,  // 0: api.InventoryDevice.device_type:type_name -> api.DeviceType
	1,  // 1: api.InventoryDevice.status:type_name -> api.InventoryStatus
	5,  // 2: api.InventoryDevice.configuration:type_name -> api.DeviceConfiguration
	39, // 3: api.InventoryDevice.tags:type_name -> api.InventoryDevice.TagsEntry
	40, // 4: api.InventoryDevice.metadata:type_name -> api.InventoryDevice.MetadataEntry
	23, // 5: api.InventoryDevice.procurement:type_name -> api.ProcurementInfo
	45, // 6: api.DeviceConfiguration.lorawan_device:type_name -> api.LoRaWANDevice
	7,  // 7: api.DeviceConfiguration.cellular_mqtt:type_name -> api.CellularMQTTConfig
	8,  // 8: api.DeviceConfiguration.cellular_tcp:type_name -> api.CellularTCPConfig
	9,  // 9: api.DeviceConfiguration.cellular_udp:type_name -> api.CellularUDPConfig
	10, // 10: api.DeviceConfiguration.cellular_http:type_name -> api.CellularHTTPConfig
	11, // 11: api.DeviceConfiguration.cellular_coap:type_name -> api.CellularCoAPConfig
	12, // 12: api.DeviceConfiguration.wifi_mqtt:type_name -> api.WiFiMQTTConfig
	13, // 13: api.DeviceConfiguration.wifi_tcp:type_name -> api.WiFiTCPConfig
	14, // 14: api.DeviceConfiguration.wifi_udp:type_name -> api.WiFiUDPConfig
	15, // 15: api.DeviceConfiguration.wifi_http:type_name -> api.WiFiHTTPConfig
	16, // 16: api.DeviceConfiguration.wifi_coap:type_name -> api.WiFiCoAPConfig
	17, // 17: api.DeviceConfiguration.websocket:type_name -> api.WebSocketConfig
	6,  // 18: api.DeviceConfiguration.gateway:type_name -> api.GatewayConfig
	46, // 19: api.DeviceConfiguration.lorawan_gateway:type_name -> api.LoRaWANGateway
	0,  // 20: api.GatewayConfig.supported_device_types:type_name -> api.DeviceType
	41, // 21: api.GatewayConfig.network_config:type_name -> api.GatewayConfig.NetworkConfigEntry
	2,  // 22: api.CellularMQTTConfig.downlink_mode:type_name -> api.DownlinkMode
	18, // 23: api.CellularMQTTConfig.authentication:type_name -> api.MQTTAuth
	21, // 24: api.CellularMQTTConfig.tls:type_name -> api.TLSConfig
	3,  // 25: api.CellularMQTTConfig.network_type:type_name -> api.CellularNetworkType
	2,  // 26: api.CellularTCPConfig.downlink_mode:type_name -> api.DownlinkMode
	21, // 27: api.CellularTCPConfig.tls:type_name -> api.TLSConfig
	3,  // 28: api.CellularTCPConfig.network_type:type_name -> api.CellularNetworkType
	2,  // 29: api.CellularUDPConfig.downlink_mode:type_name -> api.DownlinkMode
	3,  // 30: api.CellularUDPConfig.network_type:type_name -> api.CellularNetworkType
	2,  // 31: api.CellularHTTPConfig.downlink_mode:type_name -> api.DownlinkMode
	19, // 32: api.CellularHTTPConfig.authentication:type_name -> api.HTTPAuth
	21, // 33: api.CellularHTTPConfig.tls:type_name -> api.TLSConfig
	3,  // 34: api.CellularHTTPConfig.network_type:type_name -> api.CellularNetworkType
	2,  // 35: api.CellularCoAPConfig.downlink_mode:type_name -> api.DownlinkMode
	22, // 36: api.CellularCoAPConfig.dtls:type_name -> api.DTLSConfig
	3,  // 37: api.CellularCoAPConfig.network_type:type_name -> api.CellularNetworkType
	18, // 38: api.WiFiMQTTConfig.authentication:type_name -> api.MQTTAuth
	21, // 39: api.WiFiMQTTConfig.tls:type_name -> api.TLSConfig
	21, // 40: api.WiFiTCPConfig.tls:type_name -> api.TLSConfig
	19, // 41: api.WiFiHTTPConfig.authentication:type_name -> api.HTTPAuth
	21, // 42: api.WiFiHTTPConfig.tls:type_name -> api.TLSConfig
	22, // 43: api.WiFiCoAPConfig.dtls:type_name -> api.DTLSConfig
	20, // 44: api.WebSocketConfig.authentication:type_name -> api.WebSocketAuth
	21, // 45: api.WebSocketConfig.tls:type_name -> api.TLSConfig
	42, // 46: api.WebSocketAuth.credentials:type_name -> api.WebSocketAuth.CredentialsEntry
	47, // 47: api.ProcurementInfo.purchase_date:type_name -> google.protobuf.Timestamp
	47, // 48: api.ProcurementInfo.warranty_expiry:type_name -> google.protobuf.Timestamp
	4,  // 49: api.CreateInventoryDeviceRequest.device:type_name -> api.InventoryDevice
	4,  // 50: api.GetInventoryDeviceResponse.device:type_name -> api.InventoryDevice
	47, // 51: api.GetInventoryDeviceResponse.created_at:type_name -> google.protobuf.Timestamp
	47, // 52: api.GetInventoryDeviceResponse.updated_at:type_name -> google.protobuf.Timestamp
	4,  // 53: api.UpdateInventoryDeviceRequest.device:type_name -> api.InventoryDevice
	0,  // 54: api.ListInventoryDevicesRequest.device_types:type_name -> api.DeviceType
	1,  // 55: api.ListInventoryDevicesRequest.statuses:type_name -> api.InventoryStatus
	43, // 56: api.ListInventoryDevicesRequest.tags:type_name -> api.ListInventoryDevicesRequest.TagsEntry
	0,  // 57: api.InventoryDeviceListItem.device_type:type_name -> api.DeviceType
	1,  // 58: api.InventoryDeviceListItem.status:type_name -> api.InventoryStatus
	47, // 59: api.InventoryDeviceListItem.created_at:type_name -> google.protobuf.Timestamp
	47, // 60: api.InventoryDeviceListItem.updated_at:type_name -> google.protobuf.Timestamp
	31, // 61: api.ListInventoryDevicesResponse.devices:type_name -> api.InventoryDeviceListItem
	1,  // 62: api.UpdateDeviceStatusRequest.status:type_name -> api.InventoryStatus
	4,  // 63: api.BulkImportRequest.devices:type_name -> api.InventoryDevice
	36, // 64: api.BulkImportResponse.errors:type_name -> api.ImportError
	44, // 65: api.SearchInventoryDeviceRequest.criteria:type_name -> api.SearchInventoryDeviceRequest.CriteriaEntry
	31, // 66: api.SearchInventoryDeviceResponse.devices:type_name -> api.InventoryDeviceListItem
	24, // 67: api.InventoryService.Create:input_type -> api.CreateInventoryDeviceRequest
	26, // 68: api.InventoryService.Get:input_type -> api.GetInventoryDeviceRequest
	28, // 69: api.InventoryService.Update:input_type -> api.UpdateInventoryDeviceRequest
	29, // 70: api.InventoryService.Delete:input_type -> api.DeleteInventoryDeviceRequest
	30, // 71: api.InventoryService.List:input_type -> api.ListInventoryDevicesRequest
	33, // 72: api.InventoryService.UpdateStatus:input_type -> api.UpdateDeviceStatusRequest
	34, // 73: api.InventoryService.BulkImport:input_type -> api.BulkImportRequest
	37, // 74: api.InventoryService.Search:input_type -> api.SearchInventoryDeviceRequest
	25, // 75: api.InventoryService.Create:output_type -> api.CreateInventoryDeviceResponse
	27, // 76: api.InventoryService.Get:output_type -> api.GetInventoryDeviceResponse
	48, // 77: api.InventoryService.Update:output_type -> google.protobuf.Empty
	48, // 78: api.InventoryService.Delete:output_type -> google.protobuf.Empty
	32, // 79: api.InventoryService.List:output_type -> api.ListInventoryDevicesResponse
	48, // 80: api.InventoryService.UpdateStatus:output_type -> google.protobuf.Empty
	35, // 81: api.InventoryService.BulkImport:output_type -> api.BulkImportResponse
	38, // 82: api.InventoryService.Search:output_type -> api.SearchInventoryDeviceResponse
...
func file_external_service_inventory_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_external_service_inventory_proto_msgTypes[34].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_external_service_inventory_proto_enumTypes,
